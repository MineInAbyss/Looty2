...
import com.derongan.minecraft.looty.systems.ParticleSystem;
...
class EngineModule {
    ...
    @Provides
    @Singleton
    Engine provideEngine(TargetingSystem targetingSystem, DamageSystem damageSystem, IgniteSystem igniteSystem, ParticleSystem particleSystem, CleanupSystem cleanupSystem) {
